...
namespace w_escolas.Migrations
{
    ...
    [Migration("20240213210720_RefreshToken")]
            ...
            modelBuilder.Entity("w_escolas.Domain.Matriculas.Matricula", b =>
                {
                    ...
                    b.HasIndex("CursoId", "AlunoId", "TemporadaId")
                        .IsUnique();

                    b.ToTable("Matriculas", (string)null);
                });

            modelBuilder.Entity("w_escolas.Domain.Temporadas.Temporada", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("w_escolas.Domain.Cursos.Curso", b =>
                {
                    ...
                    b.HasOne("w_escolas.Domain.Temporadas.Temporada", null)
                        .WithMany("Cursos")
            ...
            modelBuilder.Entity("w_escolas.Domain.Matriculas.Matricula", b =>
                {
                    ...
                    b.HasOne("w_escolas.Domain.Temporadas.Temporada", "Temporada")
                        .WithMany("Matriculas")
                        .HasForeignKey("TemporadaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
